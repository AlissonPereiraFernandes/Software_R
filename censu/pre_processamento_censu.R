base_main = read.csv("census.csv")
base = read.csv("census.csv")
base$X = NULL

# TRANSFORMANDO ATRIBUTOS CATEGÓRICAS EM NUMÉRICAS (encode) #

table(base$sex) # contagem dos registros
unique(base$sex) # verificas os valores dos atributos
